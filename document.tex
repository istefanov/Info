...
\newcommand{\addphoto}[2]{%
  \smash{%
    \makebox[0pt][l]{%
      \raisebox{#1pt}{%
        \hspace{#2pt}\includegraphics[width=3.7cm]{IMG_9061cropped3}%IMG_9061cropped3
...
\section*{Objective}
After finishing the Master's studies I took up the opportunity to
work for a little while in the academic world, focusing on Semantic Web and
Linked Data. Now I am looking for a challenging long-term assignment, where I
can pursue my interests in Software Engineering and Systems
Development, and contribute with my practical knowledge, theoretical and
analytical skills, and diverse international experience, acquired during my time
at University and as a software engineer. 
...
\begin{tabular}{L!{\VRule}R}
leisure&Cycling; swimming; playing a Bulgarian folk instrument -- gadulka; travelling; cooking\\
%all sorts of bikes;
%swimming; 
