...
\section*{Objective}
Work as a research assistent by Prof. Cudré-Mauroux at DIUF at the University of
Fribourg.
...
customizable size, based on real data from the Faculty of Humanities. Transforming
relational university data into RDF ontology and
developing a Web visualisation for interaction with it, using Jena,
AllegroGraph, SPARQL, JavaScript, Ajax, jQuery, Cytoscape Web.\\
...
\section*{IT Skills}
\begin{tabular}{L!{\VRule}R}
software technologies&Java SE/EE, SQL, RDF, Apache Jena, SPARQL, Hibernate,
JavaScript, JSON, Ajax, jQuery, Web Services, Oracle DB, Apache Cassandra, Linux
\\
% tools&dsdad\\
...
\begin{tabular}{L!{\VRule}R}
leisure&Socialising with friends/colleagues; cycling; swimming; playing a Bulgarian folk instrument
-- gadulka; travelling locally and %since
% elementary school
abroad; cooking \\
driving licence&A+B since 2004 \cite{bowlognaBench}bolbench \cite{downScale} \cite{bowlFost}\\
\end{tabular}
