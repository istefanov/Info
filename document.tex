...
Feb. 13--Present&{\bf Scientific Collaborator at eXascale Infolab, lead by
Prof.
Philippe Cudré-Mauroux, University of Fribourg}, Switzerland\\
&{\it Document Stores Benchmarking} -- implementation of the Berlin
SPARQL Benchmark on top of document database - Couchbase (CoiuchDB) using its
...
underlying RDF datastore from the LD annotations layer, so that
data can be modified by other applications, odifications on the
